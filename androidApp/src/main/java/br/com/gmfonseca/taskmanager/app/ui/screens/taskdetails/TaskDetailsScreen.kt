package br.com.gmfonseca.taskmanager.app.ui.screens.taskdetails
...
import br.com.gmfonseca.taskmanager.app.ui.screens.taskdetails.components.TaskDetailsImage
...
fun TaskDetailsScreen(taskViewModel: TaskViewModel, onBackPress: () -> Unit) {
    ...
    Scaffold {
        Column {
            TaskDetailsImage(task = task, onBackPress = onBackPress)
